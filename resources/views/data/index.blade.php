        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    	...
                    	<tbody>
                			@foreach($datas as $data)
                				<tr>
                					...
                					<td>{{$data['warna']}}</td>
                                    <td>{{$data['cc']}}</td>
                					<td><a href={{route('data.edit',$data['id'])}} class="btn btn-warning btn-sm">Edit</a></td>
                				</tr>
                			@endforeach
                    	</tbody>
                    </table>
			                	...
			                	<table class="table table-hover">
			                    	...
			                    	<tbody>
			                			@foreach($datas as $data)
			                				<tr>
			                					<td>{{$data['nama']}}</td>
			                					<td>{{Hitung::sekalaFuzzyLower($data['harga'])}}</td>
			                					<td>{{Hitung::sekalaFuzzyLower($data['bbm'])}}</td>
			                					<td>{{Hitung::sekalaFuzzyLower($data['warna'])}}</td>
			                					<td>{{Hitung::sekalaFuzzyLower($data['cc'])}}</td>
			                				</tr>
			                			@endforeach
			                    	</tbody>
			                    </table>
			                	...
			                	<table class="table table-hover">
			                    	...
			                    	<tbody>
			                			@foreach($datas as $data)
			                				<tr>
			                					<td>{{$data['nama']}}</td>
			                					<td>{{Hitung::sekalaFuzzyMiddle($data['harga'])}}</td>
			                					<td>{{Hitung::sekalaFuzzyMiddle($data['bbm'])}}</td>
			                					<td>{{Hitung::sekalaFuzzyMiddle($data['warna'])}}</td>
			                					<td>{{Hitung::sekalaFuzzyMiddle($data['cc'])}}</td>
			                				</tr>
			                			@endforeach
			                    	</tbody>
			                    </table>
			                	...
			                	<table class="table table-hover">
			                    	...
			                    	<tbody>
			                			@foreach($datas as $data)
			                				<tr>
			                					<td>{{$data['nama']}}</td>
			                					<td>{{Hitung::sekalaFuzzyUpper($data['harga'])}}</td>
			                					<td>{{Hitung::sekalaFuzzyUpper($data['bbm'])}}</td>
			                					<td>{{Hitung::sekalaFuzzyUpper($data['warna'])}}</td>
			                					<td>{{Hitung::sekalaFuzzyUpper($data['cc'])}}</td>
			                				</tr>
			                			@endforeach
			                    	</tbody>
			                    </table>
                    ...
                    {{Session::put('alt_kriteria',$bobot_kriteria)}}
                </div>
            </div>
        </div>
    </div>
