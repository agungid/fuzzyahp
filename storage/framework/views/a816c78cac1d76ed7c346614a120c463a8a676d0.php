                    	...
                    	<tbody>
                			<?php foreach($datas as $data): ?>
                				<tr>
                                    ...
                                    <td><a href=<?php echo e(route('harga.edit',$data['id'])); ?> class="btn btn-warning btn-sm">Edit</a></td>
                				</tr>
                			<?php endforeach; ?>
                    	</tbody>
                    </table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <?php foreach($vek_min as $bobot): ?>
                                    ...
                                    <?php $harga_alt[]=round($bobot/$total,6); ?>
                                <?php endforeach; ?>
                            </tr>
                        </tbody>
                    </table>
                    <?php Session::put('harga_alt',$harga_alt); ?>
                </div>
            </div>
        </div>
    </div>
