                    	...
                    	<tbody>
                			<?php foreach($datas as $data): ?>
                				<tr>
                                    ...
                                    <td><a href=<?php echo e(route('warna.edit',$data['id'])); ?> class="btn btn-warning btn-sm">Edit</a></td>
                				</tr>
                			<?php endforeach; ?>
                    	</tbody>
                    </table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <?php foreach($vek_min as $bobot): ?>
                                    ...
                                    <?php $warna_alt[]=round($bobot/$total,6); ?>
                                <?php endforeach; ?>
                            </tr>
                        </tbody>
                    </table>
                    <?php Session::put('warna_alt',$warna_alt); ?>
                </div>
            </div>
        </div>
    </div>
