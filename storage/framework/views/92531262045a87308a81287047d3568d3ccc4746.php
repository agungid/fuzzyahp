                    	...
                    	<tbody>
                			<?php foreach($datas as $data): ?>
                				<tr>
                					...
                					<td><?php echo e($data['bbm']); ?></td>
                					<td><?php echo e($data['warna']); ?></td>
                                    <td><?php echo e($data['cc']); ?></td>
                					<td><a href=<?php echo e(route('data.edit',$data['id'])); ?> class="btn btn-warning btn-sm">Edit</a></td>
                				</tr>
                			<?php endforeach; ?>
                    	</tbody>
                    </table>
			                	...
			                	<table class="table table-hover">
			                    	...
			                    	<tbody>
			                			<?php foreach($datas as $data): ?>
			                				<tr>
			                					<td><?php echo e($data['nama']); ?></td>
			                					<td><?php echo e(Hitung::sekalaFuzzyLower($data['harga'])); ?></td>
			                					<td><?php echo e(Hitung::sekalaFuzzyLower($data['bbm'])); ?></td>
			                					<td><?php echo e(Hitung::sekalaFuzzyLower($data['warna'])); ?></td>
			                					<td><?php echo e(Hitung::sekalaFuzzyLower($data['cc'])); ?></td>
			                				</tr>
			                			<?php endforeach; ?>
			                    	</tbody>
			                    </table>
			                	...
			                	<table class="table table-hover">
			                    	...
			                    	<tbody>
			                			<?php foreach($datas as $data): ?>
			                				<tr>
			                					<td><?php echo e($data['nama']); ?></td>
			                					<td><?php echo e(Hitung::sekalaFuzzyMiddle($data['harga'])); ?></td>
			                					<td><?php echo e(Hitung::sekalaFuzzyMiddle($data['bbm'])); ?></td>
			                					<td><?php echo e(Hitung::sekalaFuzzyMiddle($data['warna'])); ?></td>
			                					<td><?php echo e(Hitung::sekalaFuzzyMiddle($data['cc'])); ?></td>
			                				</tr>
			                			<?php endforeach; ?>
			                    	</tbody>
			                    </table>
			                	...
			                	<table class="table table-hover">
			                    	...
			                    	<tbody>
			                			<?php foreach($datas as $data): ?>
			                				<tr>
			                					<td><?php echo e($data['nama']); ?></td>
			                					<td><?php echo e(Hitung::sekalaFuzzyUpper($data['harga'])); ?></td>
			                					<td><?php echo e(Hitung::sekalaFuzzyUpper($data['bbm'])); ?></td>
			                					<td><?php echo e(Hitung::sekalaFuzzyUpper($data['warna'])); ?></td>
			                					<td><?php echo e(Hitung::sekalaFuzzyUpper($data['cc'])); ?></td>
			                				</tr>
			                			<?php endforeach; ?>
			                    	</tbody>
			                    </table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <?php foreach($vek_min as $bobot): ?>
                                    ...
                                    <?php $bobot_kriteria[]=round($bobot/$total,6); ?>
                                <?php endforeach; ?>
                            </tr>
                        </tbody>
                    </table>
                    <?php echo e(Session::put('alt_kriteria',$bobot_kriteria)); ?>
